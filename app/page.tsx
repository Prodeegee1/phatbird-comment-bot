...
export default function MetaCommentBot() {
  ...
  const s = {
    ...
    topBar: { display: "flex", alignItems: "center" as const, justifyContent: "space-between" as const, marginBottom: 20 },
    logo: { display: "flex", alignItems: "center" as const, gap: 12 },
    logoIcon: { width: 40, height: 40, borderRadius: 12, background: "linear-gradient(135deg, #667eea, #764ba2)", display: "flex", alignItems: "center" as const, justifyContent: "center" as const, fontSize: 20 },
    ...
    feed: { padding: "28px", display: "flex", flexDirection: "column" as const, gap: 14, maxWidth: 900, margin: "0 auto" },
    card: { background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 18, padding: "20px 22px" },
    cardTop: { display: "flex", alignItems: "flex-start" as const, gap: 14, marginBottom: 14 },
    avatar: (platform: string) => ({ width: 44, height: 44, borderRadius: "50%", background: platform === "facebook" ? "linear-gradient(135deg, #1877F2, #42b0ff)" : "linear-gradient(135deg, #f09433, #bc1888)", display: "flex", alignItems: "center" as const, justifyContent: "center" as const, fontWeight: 800, color: "#fff", flexShrink: 0 }),
    ...
    actions: { display: "flex", gap: 8, flexWrap: "wrap" as const, marginTop: 12 },
    btn: (variant: string) => {
